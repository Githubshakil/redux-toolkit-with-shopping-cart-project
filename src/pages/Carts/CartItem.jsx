          ...
          <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              <div className="flex items-center border-gray-100">
                ...
                <span
                  className="cursor-pointer rounded-l bg-gray-100 py-2 px-3.5 duration-100 hover:bg-blue-500 hover:text-white"
                ...
                {/* Quantity Display */}
                <input
                  className="h-10 w-14 border bg-white text-center text-xs outline-none font-bold"
                  type="number"
                  value={quantity}
                  readOnly
                />
                ...
                <span
                  className="cursor-pointer rounded-r bg-gray-100 py-2 px-3.5 duration-100 hover:bg-blue-500 hover:text-white"
